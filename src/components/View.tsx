...
const contents = [
  ...
  <p>僅の晴間に二階の窓から山の方を見ると、すぐそこまでもう真白になつてゐる。山奥の村々はとうにもう雪に見舞はれてゐることであらう。</p>,
  <p>
  ...
  <p>「しかすがに心明るし……」の感は、私なんかのやうな引込思案の者にすら時ならぬ胸のときめきを覚えさせずには措かない。</p>,
  <p>みすゞかる信濃の国の安曇野へ越ゆる山ぬき道ひらくてふ</p>,
  <p>岩を破るハッパの音も聞き慣れて安けくはゐむ山の子等さへ</p>,
  <p>
  ...
  <p>やがて少時間その人と面会してとりとめもない会話を五こと六こと取交はした後で、大急ぎで歌を一首まとめ、それを色紙に書いて渡した。</p>,
  <p>しかすがに心明るしやすらけく新たなる道のひらくるおもへば</p>,
  <p>まことに坐談平語を一歩も出てゐない有りのまゝの歌に過ぎない。</p>,
  <p>
